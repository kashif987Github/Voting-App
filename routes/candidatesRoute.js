...
route.post("/", isAdmin, async (req,res)=>{
 ...
 route.post("/vote/:candidateID", isLoggedin, async(req,res)=>{
    // admin cant vote 
...
//    const candId=req.params.candidateID;
    ...
    try{
        ...
        /// next step ..if user voted then we have to make isvoted deafult false to true in userSchema ....and 2 task is to we have to save the vote and userid in candidated Schema 
